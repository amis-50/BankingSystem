...
<head>
  <title><b>Om Sai Bank</b> - Sabka Saath Sabka Vinaash</title>
  <meta charset="utf-8">
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Om Sai Bank </a>
  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="images/bank.jpg" alt="Om Sai Bank" width="1100" height="500">
      ...
      <div class="carousel-item">
        <img src="images/9.jpg" alt="Quick Deposit" width="1100" height="500">
        <div class="carousel-caption  d-none d-md-block">
  ...
  <section class="my-5">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-12">
          <h1>OM SAI  Bank</h1>
          <p1> Om Sai Bank is a part of Om Sai foundation. It is one of Znations's leading private banks and was among the first to receive approval from the Central bank of Znation (CBZ) to set up a private sector bank in 992 India.
            Today, Om Sai Bank has a banking network of 5,608 branches and 16,087 ATM's in 2,902 cities/towns. Om Sai Bank offers a diverse range of financial products and banking services to customers through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
  ...
  <section class="my-5">
    ...
    <footer class="text-center mt-2 py-5">
      <p>&copy 2022 <b>Amay Dhotre</b> </br>Chairman, Om Sai Foundation</p>
    </footer>
